...
#define AD7190_GPIO_CLK_ENABLE     __HAL_RCC_GPIOA_CLK_ENABLE

#define AD7190_SPI_GPIO_Port       GPIOA
#define AD7190_CS_Pin              GPIO_PIN_4	 
#define AD7190_SCK_Pin             GPIO_PIN_5
#define AD7190_MISO_Pin            GPIO_PIN_6
#define AD7190_MOSI_Pin            GPIO_PIN_7
#define AD7190_CS_ENABLE()         HAL_GPIO_WritePin(AD7190_SPI_GPIO_Port,AD7190_CS_Pin,GPIO_PIN_RESET)
#define AD7190_CS_DISABLE()        HAL_GPIO_WritePin(AD7190_SPI_GPIO_Port,AD7190_CS_Pin,GPIO_PIN_SET)

/* AD7190 GPIO */
#define AD7190_RDY_STATE       (AD7190_SPI_GPIO_Port->IDR & AD7190_MISO_Pin)

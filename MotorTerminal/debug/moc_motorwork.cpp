/****************************************************************************
** Meta object code from reading C++ file 'motorwork.h'
**
...
#error "The header file 'motorwork.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 15), // "sendResultToGui"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 6), // "result"
QT_MOC_LITERAL(4, 36, 15), // "doMotorSendWork"
QT_MOC_LITERAL(5, 52, 4), // "data"
QT_MOC_LITERAL(6, 57, 17) // "doMotorReciveWork"

    },
    "MotorWorker\0sendResultToGui\0\0result\0"
    "doMotorSendWork\0data\0doMotorReciveWork"
};
...
void MotorWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendResultToGui((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->doMotorSendWork((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 2: _t->doMotorReciveWork(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MotorWorker::sendResultToGui)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MotorWorker::sendResultToGui(QString _t1)
{
